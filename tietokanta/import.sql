...
-- -----------------------------------------------------
-- Table `testdatabase`.`group_table`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `testdatabase`.`group_table` ;

CREATE TABLE IF NOT EXISTS `testdatabase`.`group_table` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `testdatabase`.`useringroup` ;
...
CREATE TABLE IF NOT EXISTS `testdatabase`.`useringroup` (
  ...
  CONSTRAINT `GroupName_fk`
    ...
    REFERENCES `testdatabase`.`group_table` (`groupName`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
